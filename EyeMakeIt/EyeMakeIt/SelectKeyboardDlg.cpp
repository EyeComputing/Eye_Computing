...
BOOL SelectKeyboardDlg::OnInitDialog()
{
	...
	sub_editFont.CreatePointFont(120, TEXT("맑은 고딕"));
...
{
	// 영어 대문자 버튼 스킨 씌우기
	e_btn_smq.SetSkin(IDB_E_BGQ, IDB_E_BGQ, IDB_E_BGQ_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smw.SetSkin(IDB_E_BGW, IDB_E_BGW, IDB_E_BGW_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_sme.SetSkin(IDB_E_BGE, IDB_E_BGE, IDB_E_BGE_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smr.SetSkin(IDB_E_BGR, IDB_E_BGR, IDB_E_BGR_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smt.SetSkin(IDB_E_BGT, IDB_E_BGT, IDB_E_BGT_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smy.SetSkin(IDB_E_BGY, IDB_E_BGY, IDB_E_BGY_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smu.SetSkin(IDB_E_BGU, IDB_E_BGU, IDB_E_BGU_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smi.SetSkin(IDB_E_BGI, IDB_E_BGI, IDB_E_BGI_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smo.SetSkin(IDB_E_BGO, IDB_E_BGO, IDB_E_BGO_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smp.SetSkin(IDB_E_BGP, IDB_E_BGP, IDB_E_BGP_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_sma.SetSkin(IDB_E_BGA, IDB_E_BGA, IDB_E_BGA_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_sms.SetSkin(IDB_E_BGS, IDB_E_BGS, IDB_E_BGS_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smd.SetSkin(IDB_E_BGD, IDB_E_BGD, IDB_E_BGD_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smf.SetSkin(IDB_E_BGF, IDB_E_BGF, IDB_E_BGF_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smg.SetSkin(IDB_E_BGG, IDB_E_BGG, IDB_E_BGG_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smh.SetSkin(IDB_E_BGH, IDB_E_BGH, IDB_E_BGH_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smj.SetSkin(IDB_E_BGJ, IDB_E_BGJ, IDB_E_BGJ_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smk.SetSkin(IDB_E_BGK, IDB_E_BGK, IDB_E_BGK_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_sml.SetSkin(IDB_E_BGL, IDB_E_BGL, IDB_E_BGL_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smz.SetSkin(IDB_E_BGZ, IDB_E_BGZ, IDB_E_BGZ_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smx.SetSkin(IDB_E_BGX, IDB_E_BGX, IDB_E_BGX_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smc.SetSkin(IDB_E_BGC, IDB_E_BGC, IDB_E_BGC_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smv.SetSkin(IDB_E_BGV, IDB_E_BGV, IDB_E_BGV_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smb.SetSkin(IDB_E_BGB, IDB_E_BGB, IDB_E_BGB_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smn.SetSkin(IDB_E_BGN, IDB_E_BGN, IDB_E_BGN_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	e_btn_smm.SetSkin(IDB_E_BGM, IDB_E_BGM, IDB_E_BGM_OVER, 0, 0, IDB_MASK, 1, 0, 4);
}
...
{
	s_btn_shf.SetSkin(IDB_S_SHD, IDB_S_SHD, IDB_S_SHD_OVER, 0, 0, IDB_MASK, 1, 0, 4); // 쉬프트 눌렸을 때 이미지
	SetImgBigEngBtn(); // 소문자 -> 대문자
	// 자음 -> 쌍자음
	k_btn_bie.SetSkin(IDB_K_SSB, IDB_K_SSB, IDB_K_SSB_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	k_btn_jie.SetSkin(IDB_K_SSJ, IDB_K_SSJ, IDB_K_SSJ_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	k_btn_dig.SetSkin(IDB_K_SSD, IDB_K_SSD, IDB_K_SSD_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	k_btn_giy.SetSkin(IDB_K_SSG, IDB_K_SSG, IDB_K_SSG_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	k_btn_shi.SetSkin(IDB_K_SSS, IDB_K_SSS, IDB_K_SSS_OVER, 0, 0, IDB_MASK, 1, 0, 4);
}

// 다시 shift 시 버튼 모양 초기화
void SelectKeyboardDlg::SetImgDefaultBtn()
{
	s_btn_shf.SetSkin(IDB_S_SHF, IDB_S_SHF, IDB_S_SHF_OVER, 0, 0, IDB_MASK, 1, 0, 4); // 쉬프트 기본 이미지
	SetImgSmallEngBtn(); // 대문자 -> 소문자
	// 쌍자음 -> 자음	
	k_btn_bie.SetSkin(IDB_K_BIE, IDB_K_BIE, IDB_K_BIE_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	k_btn_jie.SetSkin(IDB_K_JIE, IDB_K_JIE, IDB_K_JIE_OVER, 0, 0, IDB_MASK, 1, 0, 4);
	k_btn_dig.SetSkin(IDB_K_DIG, IDB_K_DIG, IDB_K_DIG_OVER, 0, 0, IDB_MASK, 1, 0, 4);
